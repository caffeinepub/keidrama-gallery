...
import type { DramaEntry as _DramaEntry, ExternalBlob as _ExternalBlob, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createDramaEntry(arg0: string, arg1: bigint, arg2: string, arg3: string, arg4: Array<ExternalBlob>): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createDramaEntry(arg0, arg1, arg2, arg3, await to_candid_vec_n10(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteDramaEntry(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteDramaEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDramaEntries(): Promise<Array<DramaEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDramaEntries();
    ...
    async getDramaEntry(arg0: string): Promise<DramaEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getDramaEntry(arg0);
                return from_candid_DramaEntry_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateDramaEntry(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string, arg5: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDramaEntry(arg0, arg1, arg2, arg3, arg4, await to_candid_vec_n10(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_DramaEntry_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DramaEntry): Promise<DramaEntry> {
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DramaEntry>): Promise<Array<DramaEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_DramaEntry_n16(_uploadFile, _downloadFile, x)));
}
